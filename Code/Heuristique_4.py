...
# TRI DE LISTE PAR CONSOMMATION CROISSANTE DE RESSOURCES
    ...
    if state == "trier_liste_activites" :
        ...
        for i in range (len(activites)) :
            ...
            for j in range (i+1, len(activites)):
                ...
                if ressources[numero-1] < ressources[iMin-1] :
            ...
            if (ressources[iMin-1] < ressources[activite_a_echanger-1]) :

                tmp = activites[i]
                activites[i] = activites[res]
                activites[res] = tmp
        
        print ("Liste activites triee par consommation croissante de ressources", activites)
